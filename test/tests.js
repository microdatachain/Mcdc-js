...
var mcdc = require("../index.js");

describe("Mcdc JS", function () {
	...
	it("should have properties", function () {
		...
		properties.forEach(function (property) {
			(mcdc).should.have.property(property);
		});
	});

	describe("crypto.js", function () {
		var crypto = mcdc.crypto;
	...
	describe("dapp.js", function () {
		...
		describe("#createDapp", function () {
			...
			var options = {
				category: 0,
				name: "mcdc Guestbook",
				description: "The official mcdc guestbook",
			...
			describe("returned dapp", function () {
				var keys = mcdc.crypto.getKeys("secret");
				var secondKeys = mcdc.crypto.getKeys("secret 2");
				...
				it("should be signed correctly", function () {
					var result = mcdc.crypto.verify(trs);
					(result).should.be.ok;
				});
				...
				it("should be second signed correctly", function () {
					trs.amount = 0;
					var result = mcdc.crypto.verifySecondSignature(trs, secondKeys.publicKey);
					(result).should.be.ok;
				});
	...
	describe("delegate.js", function () {
		...
		describe("#createDelegate", function () {
			...
			describe("returned delegate", function () {
				...
				it("should be signed correctly", function () {
					var result = mcdc.crypto.verify(trs, keys.publicKey);
					(result).should.be.ok;
				});
				...
				it("should not be second signed correctly now", function () {
					trs.amount = 100;
					var result = mcdc.crypto.verify(trs, secondKeys.publicKey);
					(result).should.be.not.ok;
				});
	...
	describe("transaction.js", function () {
		var transaction = mcdc.transaction;
		...
		describe("#createTransaction with second secret", function () {
			...
			var keys = mcdc.crypto.getKeys(secondSecret);
			...
			describe("returned transaction", function () {
				...
				it("should be second signed correctly", function () {
					var result = mcdc.crypto.verifySecondSignature(trs, keys.publicKey);
					(result).should.be.ok;
				});
	...
	describe("vote.js", function () {
		...
		describe("#createVote", function () {
			var createVote = vote.createVote,
				vt = null,
				publicKey = mcdc.crypto.getKeys("secret").publicKey,
			...
			describe("returned vote", function () {
				...
				it("should be signed correctly", function () {
					var result = mcdc.crypto.verify(vt);
					(result).should.be.ok;
				});

				it("should be second signed correctly", function () {
					var result = mcdc.crypto.verifySecondSignature(vt, mcdc.crypto.getKeys("second secret").publicKey);
					(result).should.be.ok;
				});
